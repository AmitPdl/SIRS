...
parser.add_argument('--save_model_freq',default=2,type=int,help="frequency to save model")
...
parser.add_argument('--num_epochs',type=int,default=50,help="total epoch of training")
