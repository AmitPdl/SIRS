...
class Solver:
    ...
    def train_model(self):
        ...
        datadir = '/scratch/apaudya/Summer/RAGNet/RAGNet-master'
        ...
        train_dataset = datasets.DSRDataset(
            datadir_syn, read_fns('data/VOC2012_224_train_png.txt'), size= 9999, enable_transforms=True)

        train_dataset_real = datasets.DSRTestDataset(datadir_real, size = 9999, enable_transforms=True, if_align=True)
        ...
        for index, (input_b,gt_t,gt_r, is_ref_syn) in enumerate(train_dataloader_fusion):
            ...
            if index%2==0:
                ...
                with torch.no_grad():
                    ...
                    output_t, r_final, rr ,list_map, list_R, list_mask, list_mask_encoder, list_map_encoder = self.gt_model(pretrained_T, pretrained_R, map_thr, map_encoder)
            ...
            pretrained_R, _ = self.gr_model(input_b, self.vgg(input_b))
            output_t, r_final, rr, list_map, list_R, list_mask, list_mask_encoder, list_map_encoder = self.gt_model(pretrained_T, pretrained_R, map_thr, map_encoder)
